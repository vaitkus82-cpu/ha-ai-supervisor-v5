...
def load_server(temp_dir: str):
    ...
    spec = importlib.util.spec_from_file_location('connector_alpha5_test', SERVER_PATH)
...
class ConnectorAlpha5Tests(unittest.TestCase):
    def setUp(self):
    ...
    def test_component_catalog_maps_automation_script_and_helper(self):
        files = [{
