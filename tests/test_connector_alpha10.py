...
def load_server(data_dir: str, config_dir: str):
    ...
    spec = importlib.util.spec_from_file_location("connector_alpha10_test", SERVER_PATH)
...
class ConnectorAlpha10Tests(unittest.TestCase):
    def setUp(self):
...
"""
    ...
    def test_connector_version_is_alpha10(self):
        self.assertEqual("5.0.0-alpha10", self.mod.APP_VERSION)
