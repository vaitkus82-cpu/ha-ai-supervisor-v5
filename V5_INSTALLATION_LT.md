# AI Supervisor V5 Alpha12 atnaujinimas

1. Įkelkite šio paketo vidinio `ha-ai-supervisor-v5` aplanko turinį į GitHub saugyklą.
2. Patikrinkite `ai_supervisor_connector/config.yaml`: `version: "5.0.0-alpha12"`.
3. Home Assistant pasirinkite `Settings -> Apps -> App store -> Check for updates`.
4. Atnaujinkite Connector į Alpha12 ir paspauskite `Restart`.
