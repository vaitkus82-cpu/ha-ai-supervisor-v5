# AI Supervisor V5 Alpha7 atnaujinimas – žingsnis po žingsnio

Alpha7 atnaujina abi dalis:

- darbo mini PC – **Windows Engine 5.0.0-alpha7**;
- Home Assistant – **Connector 5.0.0-alpha7**.

## Ką taiso Alpha7

Alpha6 teisingai rado tris užuolaidas, bet nerado `packages/50_curtains.yaml` automatikų, skriptų ir helperių, nes dalis entity nuorodų buvo Jinja šablonuose ir pasirinktiniuose laukuose. Alpha7 indeksuoja tikslius entity ID visame YAML tekste ir susieja pagrindinį package failą su visais jame aprašytais komponentais.

## 1. Atnaujinti Windows Engine

1. Atsisiųskite `ai-supervisor-v5-windows-engine-alpha7.zip`.
...
7. Patikrinkite, kad rodoma `Engine 5.0.0-alpha7`, `OpenAI: paruošta`, `Connector: susietas`.

## 2. Įkelti Connector į GitHub

1. Atsisiųskite `ha-ai-supervisor-v5-connector-alpha7.zip`.
2. Išskleiskite ZIP.
...
7. Commit pavadinimas: `Upgrade V5 to alpha7 package and Jinja index`.
8. Patikrinkite `ai_supervisor_connector/config.yaml`: turi būti `version: "5.0.0-alpha7"`.
...
4. Atnaujinkite `5.0.0-alpha6 → 5.0.0-alpha7`.
