...
Alpha5 is intended for a trusted local network. The Windows installer opens TCP port 8765 only for the Windows **Private** firewall profile and `LocalSubnet`. No router port forwarding is required or supported.
